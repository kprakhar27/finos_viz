...
perspective-viewer.workspace-master-widget regular-table {
  --pv-divider--color: #E0E4E9 !important;
}
perspective-viewer.workspace-master-widget regular-table td,
perspective-viewer.workspace-master-widget regular-table th {
  border-color: #E0E4E9;
}
