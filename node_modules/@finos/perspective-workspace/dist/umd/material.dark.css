...
perspective-workspace {
  ...
  color: white;
  --workspace-master--background-color: #242526;
  --workspace-tabbar--background-color: #2A2C2F;
  --workspace-tabbar--border: 1px solid #3B3F46;
  --workspace-tabbar--border-color: #3B3F46;
  --workspace-inactive-blur--background-color: rgba(0, 0, 0, 0.1);
...
perspective-viewer.workspace-detail-widget {
  ...
  --null--background: rgba(0, 0, 0, 0.02);
  --null--box-shadow: inset 0 2px 4px 0 rgba(0, 0, 0, 0.1);
  ...
  --d3fc-axis--ticks: #161616;
  --d3fc-axis--lines: #C5C9D0;
  --d3fc-legend--background: rgba(255, 255, 255, 0.8);
  background-color: #242526;
  color: white;
  --background-color: #242526;
  --column--background: #242526;
  --null--background: rgba(0, 0, 0, 0.08);
  --color: white;
  ...
  --inactive--color: #3B3F46;
  --pv-divider--color: #3B3F46;
  ...
  --column-container--margin: 6px 0px 0px 0px;
  ...
  --plugin--border: 1px solid #3B3F46;
}
perspective-viewer.workspace-detail-widget regular-table::-webkit-scrollbar-thumb {
  background-color: #E0E4E9;
}
perspective-viewer.workspace-detail-widget regular-table {
...
perspective-viewer.workspace-detail-widget regular-table:hover {
  -webkit-mask-position: -12px -12px, top right, bottom left;
}
perspective-viewer.workspace-detail-widget table {
  color: white;
}
perspective-viewer.workspace-detail-widget table tr:hover {
  color: white;
}
perspective-viewer.workspace-detail-widget regular-table {
...
perspective-viewer.workspace-detail-widget tbody th:empty {
...
perspective-viewer.workspace-master-widget regular-table::-webkit-scrollbar-thumb {
  background-color: #E0E4E9;
}
perspective-viewer.workspace-master-widget regular-table {
  -webkit-mask-image: linear-gradient(black, black), linear-gradient(to top, transparent 10%, black 90%), linear-gradient(to left, transparent 10%, black 90%);
  -webkit-mask-position: -12px -12px, bottom right, bottom right;
  -webkit-mask-size: 100% 100%, 12px 1000%, 1000% 12px;
  -webkit-mask-repeat: no-repeat;
...
perspective-viewer.workspace-master-widget regular-table:hover {
  -webkit-mask-position: -12px -12px, top right, bottom left;
}
perspective-viewer.workspace-master-widget table {
  color: white;
}
perspective-viewer.workspace-master-widget table tr:hover {
  color: white;
}
perspective-viewer.workspace-master-widget regular-table {
  --rt-pos-cell--color: #7DC3F0;
...
perspective-viewer.workspace-master-widget regular-table table tbody tr td,
perspective-viewer.workspace-master-widget regular-table table tbody tr th {
  --rt-hover--border-color: #61656E;
  border-top-color: #3B3F46;
}
perspective-viewer.workspace-master-widget regular-table::-webkit-scrollbar-thumb {
...
perspective-viewer.workspace-master-widget tbody th:empty {
  background: linear-gradient(to right, transparent 9px, #3B3F46 10px, transparent 11px);
  background-repeat: no-repeat;
  background-position: 0px -10px;
}
