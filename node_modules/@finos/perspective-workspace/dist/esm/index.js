...
PerspectiveWorkspaceElement = (_dec = bindTemplate(template, style), _dec(_class = class PerspectiveWorkspaceElement extends _CustomElement {
  /***************************************************************************
   *
   * Public
   *
  ...
  connectedCallback() {
    ...
    this._register_light_dom_listener(); // TODO: check we only insert one of these
