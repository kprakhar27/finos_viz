...
const load_perspective = require("./@finos/perspective-cpp/dist/cjs/perspective.cpp.js").default; // eslint-disable-next-line no-undef
...
const DEFAULT_ASSETS = ["@finos/perspective/dist/umd", "@finos/perspective-bench/dist", "@finos/perspective-viewer/dist/umd", "@finos/perspective-viewer-datagrid/dist/umd", "@finos/perspective-viewer-d3fc/dist/umd", "@finos/perspective-workspace/dist/umd"];
const CONTENT_TYPES = {
  ".js": "text/javascript",
  ".css": "text/css",
...
class WebSocketServer extends WebSocketManager {
  constructor({
    ...
    assets = assets || ["./"]; // Serve Perspective files through HTTP

    this._server = http.createServer(perspective_assets(assets, host_psp)); // Serve Worker API through WebSockets
