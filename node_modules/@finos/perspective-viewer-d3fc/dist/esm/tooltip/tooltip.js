...
function getTooltipDiv(container) {
  return getOrCreateElement(container, "div.tooltip", () => container.append("div").attr("class", "tooltip").style("z-index", 3).style("opacity", 0).html(tooltipTemplate));
}
...
function showTooltip(containerNode, node, tooltipDiv, centered) {
  ...
  tooltipDiv.style("left", `${left}px`).style("top", `${top}px`) // .transition()
  // .duration(200)
  .style("opacity", 0.9);
