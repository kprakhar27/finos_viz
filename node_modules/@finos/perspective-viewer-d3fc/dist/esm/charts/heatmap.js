...
function heatmapChart(container, settings) {
  ...
  const yAxis = axisFactory(settings).excludeType(AXIS_TYPES.linear).settingName("splitValues").valueName("mainValue").orient("vertical")(data);
  ...
  const zoomChart = zoomableChart().chart(chart).settings(settings).xScale(xAxis.scale).yScale(yAxis.scale); // render
